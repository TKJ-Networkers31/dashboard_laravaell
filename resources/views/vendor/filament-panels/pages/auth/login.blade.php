...
<body>
    ...
    <div class="form-side">
        ...
        <div class="form-inner">
            ...
            <div class="logo-block">
                <img class="logo-img" src="{{ asset('images/logo_smk2_webp.webp') }}" alt="Logo SMKN 2 Baleendah">
                <div class="logo-text">
    ...
    {{-- RIGHT: BG IMAGE --}}
    <div class="bg-side">
        <img class="bg-img" src="{{ asset('images/bg_login_webp.webp') }}" alt="SMKN 2 Baleendah">
